...
type StudentHeaderAssistantProps = { studentName?: string; grade?: string; apiBaseUrl?: string };

export function StudentHeaderAssistant({ studentName, grade, apiBaseUrl }: StudentHeaderAssistantProps) {
  ...
  return <>
    ...
    <ChatDrawer isOpen={open} onClose={() => setOpen(false)} sessionType="student" studentContext={{ name: studentName, grade }} apiBaseUrl={apiBaseUrl} />
  </>;
}
